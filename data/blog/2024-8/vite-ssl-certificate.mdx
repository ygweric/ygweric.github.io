...
![xxxxx.png](/static/images/blog/2024-8/vite-ssl-certificate/1.png)

能看到vite的proxy使用的时 [`http-proxy`](https://github.com/http-party/node-http-proxy#options). 进入看看详情：

https://github.com/http-party/node-http-proxy#options
![xxxxx.png](/static/images/blog/2024-8/vite-ssl-certificate/2.png)
...
![xxxxx.png](/static/images/blog/2024-8/vite-ssl-certificate/3.png)
