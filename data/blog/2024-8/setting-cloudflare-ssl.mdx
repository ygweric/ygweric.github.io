...
![526](/static/images/blog/2024-8/setting-cloudflare-ssl/526.png)


网上说需要将CloudFlare的 **SSL/TLS encryption mode** 设置为**Full**。

![config](/static/images/blog/2024-8/setting-cloudflare-ssl/config.png)
...
1. 打开配置页面
![rule1](/static/images/blog/2024-8/setting-cloudflare-ssl/rule1.png)


2. 制定规则，选择域名
![rule2](/static/images/blog/2024-8/setting-cloudflare-ssl/rule2.png)

3. 为规则选择对应ssl策略。
![rule3](/static/images/blog/2024-8/setting-cloudflare-ssl/rule3.png)
