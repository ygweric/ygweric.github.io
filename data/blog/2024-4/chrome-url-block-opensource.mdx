---
title: '开源 chrome 插件： URL Block'
date: '2024-04-10'
tags: ['开源', '浏览器插件', 'Chrome插件']
draft: false
summary:
---
...
![screenshot-1](https://github.com/ygweric/chrome-url-block/raw/main-v2/images/screenshot-1.png)
![screenshot-2](https://github.com/ygweric/chrome-url-block/raw/main-v2/images/screenshot-2.png)
...
- 主要自用很方便，纯自嗨
- 目前用户1.7k左右
  ![users-count](https://github.com/ygweric/chrome-url-block/raw/main-v2/images/users-count.png)
